...
public class TesteGmail {
	...
	private static final String EMAIL = "decioluckow@gmail.com";
	private static final String SENHA = "nku72lkw";
	...
	public static void main(String[] args) throws AddressException, MessagingException {
		...
		email.setRecipient(Message.RecipientType.TO, new InternetAddress("decioluckow@gmail.com"));
